...
import { Activity, DollarSign, Box, Zap, TrendingDown, ShieldAlert, HeartPulse, Sparkles, AlertCircle, Network, ServerCrash, ZapOff, ArrowRight, Gauge, Target, SearchCode, ShieldCheck, Wifi, ExternalLink, ChevronRight } from 'lucide-react';
              ...
              <div className="bg-zinc-50 dark:bg-zinc-950/50 p-6 rounded-3xl border border-zinc-100 dark:border-zinc-800">
                 <div className="flex justify-between items-center mb-4">
                    ...
                    <span className={`text-[10px] font-black uppercase px-2 py-0.5 rounded-md ${
                       reliabilityMetrics.severity === 'Healthy' ? 'bg-emerald-500/10 text-emerald-500' : 
