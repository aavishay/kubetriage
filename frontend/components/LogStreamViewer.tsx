        ...
        <div className="flex flex-col h-full bg-bg-card rounded-[2rem] overflow-hidden border border-border-main shadow-2xl font-mono text-xs animate-fade-in">
            ...
            <div className="flex items-center justify-between px-5 py-3.5 bg-bg-hover/30 border-b border-border-main">
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative group/pod">
                        <select
                            ...
                            className="kt-input appearance-none pr-7 cursor-pointer font-bold text-xs"
                        >
                            {podNames.map(p => (
                ...
                <div className="flex items-center gap-2">
                    ...
                    {onClose && (
                        <button onClick={onClose} className="p-2.5 rounded-xl bg-bg-card border border-border-main text-text-tertiary hover:text-rose-500 hover:border-rose-500/30 transition-all shadow-sm active:translate-y-[1px] active:brightness-95 ml-2">
